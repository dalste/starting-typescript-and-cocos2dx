(function( dalste, undefined ) {
    ...
    /**
 * @class SceneExtended -  provides subscribable signal wrappers around scene lifecycle events  implements INodeLifecycleExtensions 
 * onEnter
 ...
 */
     ...
     mvc.SceneExtended = cc.Scene.extend({
